        ...
        <section class="mt-8">
            ...
            <div class="grid grid-cols-4 justify-center gap-4 mb-4">
                ...
                <div class="max-w-sm rounded overflow-hidden shadow-lg">
                    <img class="w-full" src="{{ asset('images/window.jpg') }}" alt="Card image cap">
                    <div class="px-6 py-4">
                        <div class="font-bold text-xl mb-2">Card title</div>
                    </div>
                    <div class="px-6 pt-4 pb-2">
                        <a href="#" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Pakai</a>
                    </div>
                </div>
